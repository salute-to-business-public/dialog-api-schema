...
func (*RequestRegisterDevice) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{0} }
...
func (*ResponseDeviceRequest) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{1} }
...
func (*RequestExchangeAuthIdForToken) Descriptor() ([]byte, []int) { return fileDescriptor20, []int{3} }
...
func init() { proto.RegisterFile("registration.proto", fileDescriptor20) }
