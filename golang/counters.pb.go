...
func (m *UnreadDialog) XXX_Size() int {
	return xxx_messageInfo_UnreadDialog.Size(m)
}
...
func (m *AppCounters) XXX_Size() int {
	return xxx_messageInfo_AppCounters.Size(m)
}
...
func (m *UpdateCountersChanged) XXX_Size() int {
	return xxx_messageInfo_UpdateCountersChanged.Size(m)
}
...
func (m *UpdateCountersChanged) GetTs() *wrappers.Int64Value {
	if m != nil {
		return m.Ts
	}
	return nil
