...
func (*GetDifferenceCommand) Descriptor() ([]byte, []int) {
	return fileDescriptorGatewayService, []int{0}
}

func (m *GetDifferenceCommand) GetSeq() *google_protobuf.Int32Value {
	if m != nil {
		return m.Seq
	}
	return nil
...
func (*ServiceUpdate) Descriptor() ([]byte, []int) { return fileDescriptorGatewayService, []int{1} }
...
func (m *ServiceUpdate) GetObsoleteUpdate() *google_protobuf.BytesValue {
...
func (m *GetDifferenceCommand) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Seq != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintGatewayService(dAtA, i, uint64(m.Seq.Size()))
		n1, err := m.Seq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
...
func (m *ServiceUpdate_ObsoleteUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ObsoleteUpdate != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintGatewayService(dAtA, i, uint64(m.ObsoleteUpdate.Size()))
		n3, err := m.ObsoleteUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func encodeFixed64GatewayService(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32GatewayService(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
	...
	for iNdEx < l {
		...
		case 3:
			for {
				...
				next, err := skipGatewayService(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
func init() { proto.RegisterFile("gateway_service.proto", fileDescriptorGatewayService) }

var fileDescriptorGatewayService = []byte{
	// 303 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0xe2, 0x12, 0x4d, 0x4f, 0x2c, 0x49,
	...
	,
	...
	0x63, 0x39, 0x86, 0x45, 0x4c, 0xcc, 0x8e, 0x01, 0x9e, 0xbb, 0xc0, 0x64, 0x12, 0x1b, 0xd8, 0x2a,
	0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x7f, 0x3f, 0xd9, 0xbc, 0x8d, 0x01, 0x00, 0x00,
}
