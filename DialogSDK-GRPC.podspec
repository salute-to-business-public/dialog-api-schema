...
#CMD
  ...
  s.subspec "Messages" do |ms|
    ms.source_files = "#{dir}/*.pbobjc.{h,m}", "#{dir}/scalapb/*.pbobjc.{h,m}", "#{dir}/google/api/*.pbobjc.{h,m}"
  ...
  s.subspec "Services" do |ss|
    ss.source_files = "#{dir}/*.pbobjc.{h,m}", "#{dir}/scalapb/*.pbobjc.{h,m}", "#{dir}/google/api/*.pbobjc.{h,m}"
